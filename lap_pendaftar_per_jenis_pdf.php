...
$date=date('d / M / Y');
$pdf->Ln(8);
$pdf->Text(50,17,'LAPORAN DAFTAR PENDAFTAR CALON BEASISWA PER JENIS BEASISWA');
...
$lap_calon_siswa=mysql_query("select * from pendaftaran,jenis_beasiswa where pendaftaran.kd_jenisbeasiswa=jenis_beasiswa.kd_jenisbeasiswa and  pendaftaran.kd_jenisbeasiswa='$kd_jenisbeasiswa'");
while($hasil=mysql_fetch_array($lap_calon_siswa))
{
$pdf->Ln(20);
$pdf->cell(10,60,'JENIS BEASISWA        : '.$hasil[nm_jenisbeasiswa],0,1,'L',0);
...
$pdf->Cell(82,12,'JENIS RUMAH TINGGAL',1,0,'C',1);
...
$pdf->Cell(82,12,$hasil[jenis_rumah],1,0,'L',1);
