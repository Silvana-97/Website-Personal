...
$date=date('d / M / Y');
$pdf->Ln(8);
$pdf->Text(60,17,'LAPORAN DAFTAR SISWA BARU PER TAHUN AJARAN & KELAS');
...
$pdf->Cell(80,12,'ALAMAT ORTU',1,0,'C',1);
...
$pdf->Cell(80,12,$hasil[alamat_ortu],1,0,'L',1);
