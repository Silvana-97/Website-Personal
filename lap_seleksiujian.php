...
$date=date('d / M / Y');
$pdf->Ln(8);
$pdf->Text(60,17,'LAPORAN DAFTAR CALON SISWA YANG LULUS SELEKSI UJIAN PER TAHUN AJARAN');
...
$lap_calon_siswa=mysql_query("select * from seleksi_ujian,calon_siswa,tahunajaran where seleksi_ujian.nomor_registrasi=calon_siswa.nomor_registrasi and seleksi_ujian.kd_tahunajaran=tahunajaran.kd_tahunajaran and seleksi_ujian.kd_tahunajaran='$kd_tahunajaran'");
...
$pdf->Cell(40,12,'STATUS KELULUSAN',1,0,'C',1);
...
$pdf->Cell(40,12,$hasil[status],1,0,'C',1);
