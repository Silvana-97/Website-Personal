                                ...
                                <div class="col-xs-12">
                                  <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs">
                                      <li class="active"><a href="#fa-icons" data-toggle="tab">Laporan Pendaftar Penerimaan Beasiswa Per Jenis Beasiswa</a></li>
                                    </ul>
                                   ...
                                   <div class="box">
                                    <div class="box-body scrolltable">
                                   				<label>TAMPILKAN DAFTAR MAHASISWA PER JENIS BEASISWA</label>
                                   				<form id="form1" name="form1" method="post" action="lap_pendaftar_per_jenis_pdf.php" target="_blank">
