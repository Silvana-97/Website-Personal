...
$daftar=mysql_query("select * from seleksi_brks,calon_siswa where seleksi_brks.nomor_registrasi=calon_siswa.nomor_registrasi ");
}
 ...
 $nomor_registrasi = $_GET['nomor_registrasi'];
							$query=mysql_query("SELECT * FROM daftar where nomor_registrasi='$nomor_registrasi'")or die(mysql_error());
                                        ...
                                        <tbody>
                                            ...
                                            echo "
                                                        <tr>
															...
															<td class='center'>".$dt['nun']."</td>
															<td class='center'>".$dt['status_lulus']."</td>
                                                            <td class='center'>
															<a href=?page=10&nomor_registrasi=$dt[nomor_registrasi] title=\"INPUT NILAI UJIAN\">".$link."</a> 
															</td>";
														?> 
                                                        </tr>
                                            <?php $counter ++; } ?>
