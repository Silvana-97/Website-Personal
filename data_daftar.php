...
$daftar=mysql_query("select * from pendaftaran order by npm DESC");
}
                                        ...
                                        <tbody>
                                            ...
                                            echo "
                                                        <tr>
															...
															<td>".$kata."</td>
                                                            <td class='center'>
															<a href=?page=aktvs_pendaftar&npm=$dt[0] title=\"Aktivasi Akun\"><img src=\"icon/ok.png\" /></a> | 
															<!--<a href=?page=9&npm=$dt[0] title=\"SELEKSI BERKAS\"><img src=\"icon/edit.png\" /></a>-->
															<a href=hapus_daftar.php?hapus&npm=$dt[npm] title=\"Hapus Akun Pendaftar\"><img src=\"icon/hapus.png\" /></a>
															</td>";
														?> 
                                                        </tr>
                                            <?php $counter ++; } ?>
