...
$date=date('d / M / Y');
$pdf->Ln(8);
$pdf->Text(60,17,'LAPORAN DAFTAR CALON SISWA YANG LULUS SELEKSI BERKAS PER TAHUN AJARAN');
...
$lap_calon_siswa=mysql_query("select * from seleksi_brks,calon_siswa,tahunajaran where seleksi_brks.nomor_registrasi=calon_siswa.nomor_registrasi and seleksi_brks.kd_tahunajaran=tahunajaran.kd_tahunajaran and seleksi_brks.kd_tahunajaran='$kd_tahunajaran'");
...
$pdf->Cell(40,12,$hasil[status_lulus],1,0,'C',1);
