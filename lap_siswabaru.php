                                ...
                                <div class="col-xs-12">
                                  <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs">
                                      <li class="active"><a href="#fa-icons" data-toggle="tab">Laporan Siswa Baru Per Tahun Ajaran</a></li>
                                    </ul>
                                   ...
                                   <div class="box">
                                    <div class="box-body scrolltable">
                                   				<form id="form1" name="form1" method="post" action="lap_siswabaru_ta.php" target="_blank">
